...
define('EXTEND_PATH', L_APP_PATH . 'ext/');//define('EXTEND_PATH', APP_PATH . 'Extend/');
define('CONF_PATH',  L_APP_PATH . 'conf/');//define('CONF_PATH',  APP_PATH.'Conf/');

//user consont
define('L_USERINFO','userinfo');
//load & init lavender
